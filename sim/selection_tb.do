...
if [ string match $sim_type rtl ] { 
  #vsim -t ps -vopt -voptargs=+acc work.cfg_selection_tb_rtl -wlf selection_tb_rtl.wlf
  vsim -t ps work.cfg_selection_tb_rtl -wlf selection_tb_rtl.wlf
  add log -r /*
  #do ../sim/selection_tb_wave.do.do
