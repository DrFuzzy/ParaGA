...
if [ string match $sim_type rtl ] { 
  #vsim -t ps -vopt -voptargs=+acc work.cfg_fit_eval_tb_rtl -wlf fit_eval_tb_rtl.wlf
  vsim -t ps work.cfg_fit_eval_tb_rtl -wlf fit_eval_tb_rtl.wlf
  add log -r /*
  #do ../sim/fit_eval_tb_wave.do.do
