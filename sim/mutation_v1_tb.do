...
if [ string match $sim_type rtl ] { 
  #vsim -t ps -vopt -voptargs=+acc work.cfg_mutation_v1_tb_rtl -wlf mutation_v1_tb_rtl.wlf
  vsim -t ps work.cfg_mutation_v1_tb_rtl -wlf mutation_v1_tb_rtl.wlf
  add log -r /*
  #do ../sim/mutation_v1_tb_wave.do.do
