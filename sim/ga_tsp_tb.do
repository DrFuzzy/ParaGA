...
if [ string match $sim_type rtl ] { 
  #vsim -t ps -vopt -voptargs=+acc work.cfg_ga_tsp_tb_rtl -wlf ga_tsp_tb_rtl.wlf
  vsim -t ps work.cfg_ga_tsp_tb_rtl -wlf D:\Designs\GA_eval\vhd\ga_tsp_tb_rtl.wlf
  add log -r /*
  do ../sim/ga_tsp_tb_wave_rtl.do
