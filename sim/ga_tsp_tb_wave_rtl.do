...
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u4/u0/counter
...
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u4/u1/cont
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u4/u1/cont2
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u4/u1/fin
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u4/u1/done_p
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u4/u1/done
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u4/u1/equal
...
add wave -noupdate -format Literal -radix unsigned /ga_tsp_tb/u_bench/u6/ingene1
add wave -noupdate -format Literal -radix unsigned /ga_tsp_tb/u_bench/u6/ingene2
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u6/rd
add wave -noupdate -format Literal -radix unsigned /ga_tsp_tb/u_bench/u6/crossoffspr1
...
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u6/town
...
add wave -noupdate -format Literal -radix unsigned /ga_tsp_tb/u_bench/u7/mutoffspr
...
add wave -noupdate -format Literal -radix unsigned /ga_tsp_tb/u_bench/u7/ingene
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u7/rd
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u7/mutout
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u7/mutout_p1
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u7/ingene_mut
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u7/temp1
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u7/temp2
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u7/rng1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u7/done
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u7/done_p
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u7/reduce_1
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u7/reduce_2
...
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u10/sreg
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u10/next_sreg
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/mut_rd_p1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/rng_rd_p1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/rng_rd
...
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u10/count2
...
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_eval1_p1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_eval2_p1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_eval3_p1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_sel_p1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_ram1_p1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_ram2_p1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_mut_p1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_eval1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_eval2
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_eval3
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_sel
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_ram1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_ram2
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_cnt_adapt
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_mut
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_obs_p1
add wave -noupdate -format Logic /ga_tsp_tb/u_bench/u10/dummy_obs
...
add wave -noupdate -format Literal /ga_tsp_tb/u_bench/u10/nparents
...
WaveRestoreCursors {{Cursor 1} {3515000 ps} 0}
...
update
WaveRestoreZoom {3479167 ps} {3581707 ps}
